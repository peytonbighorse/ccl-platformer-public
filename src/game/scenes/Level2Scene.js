...
export default class Level2Scene extends Phaser.Scene {
  ...
  create() {
    ...
    //background music
    this.music = this.sound.add("masquerade", { loop: true, volume: 1 });
    this.music.play();
    ...
    this.sfxPowerUp = this.sound.add("sfx_power_up", { volume: 0.5 });
    ...
    this.blob1MaxX = 750; //right side bounds
    this.enemySpeed = 120;
    ...
    //set blob patrol
    this.blob2MinX = 800; //left side bounds
    this.blob2MaxX = 1600; //right side bounds
    ...
    //set enemy patrol
    this.mouseMinX = 1280; //left side bounds
    this.mouseMaxX = 1360; //right side bounds
    ...
    this.platforms
      .create(this.platformX + 85, this.platformY + 130, "platform")
      .setAlpha(0)
      .setScale(1.55, 0.25)
      .refreshBody();

    this.platforms
      .create(this.platformX - 115, this.platformY + 125, "platform")
      .setAlpha(0)
      .setScale(0.13, 0.46)
      .refreshBody();

    this.platforms
      .create(this.platformX + 300, this.platformY + 125, "platform")
      .setAlpha(0)
      .setScale(0.13, 0.46)
      .refreshBody();

    this.platforms
      .create(this.platformX + 95, this.platformY + 28, "platform")
      .setAlpha(0)
      .setScale(1.25, 0.04)
      .refreshBody();
    ...
    //window
    this.platforms
      .create(this.platformX + 95, this.platformY - 48, "platform")
      .setAlpha(0)
      .setScale(1.3, 0.05)
      .refreshBody();
    ...
    //plant
    this.platforms
      .create(this.platformX - 126, this.platformY - 125, "platform")
      .setAlpha(0)
      .setScale(0.18, 0.05)
      .refreshBody();
    ...
    //georgie frame
    this.platforms
      .create(this.platformX - 231, this.platformY - 185, "platform")
      .setAlpha(0)
      .setScale(0.35, 0.05)
      .refreshBody();

    this.platforms
      .create(this.platformX - 231, this.platformY - 115, "platform")
      .setAlpha(0)
      .setScale(0.37, 0.05)
      .refreshBody();
    ...
    //lamp
    this.platforms
      .create(this.platformX - 362, this.platformY - 125, "platform")
      .setAlpha(0)
      .setScale(0.2, 0.05)
      .refreshBody();

    this.platforms
      .create(this.platformX - 362, this.platformY - 52, "platform")
      .setAlpha(0)
      .setScale(0.4, 0.05)
      .refreshBody();
    ...
    this.platforms
      .create(this.platformX + 575, this.platformY + 80, "platform")
      .setAlpha(0)
      .setScale(1, 0.04)
      .refreshBody();
    this.platforms
      .create(this.platformX + 575, this.platformY + 90, "platform")
      .setAlpha(0)
      .setScale(1.1, 0.04)
      .refreshBody();

    this.platforms
      .create(this.platformX + 577, this.platformY + 35, "platform")
      .setAlpha(0)
      .setScale(0.8, 0.02)
      .refreshBody();
    ...
    //patsy frame
    this.platforms
      .create(this.platformX + 376, this.platformY - 205, "platform")
      .setAlpha(0)
      .setScale(0.35, 0.05)
      .refreshBody();

    this.platforms
      .create(this.platformX + 376, this.platformY - 140, "platform")
      .setAlpha(0)
      .setScale(0.37, 0.05)
      .refreshBody();
    ...
    //denny frame
    this.platforms
      .create(this.platformX + 510, this.platformY - 170, "platform")
      .setAlpha(0)
      .setScale(0.35, 0.05)
      .refreshBody();

    this.platforms
      .create(this.platformX + 510, this.platformY - 105, "platform")
      .setAlpha(0)
      .setScale(0.37, 0.05)
      .refreshBody();
    ...
    //shelf
    this.platforms
      .create(this.platformX + 865, this.platformY - 152, "platform")
      .setAlpha(0)
      .setScale(0.6, 0.06)
      .refreshBody();

    this.platforms
      .create(this.platformX + 865, this.platformY - 58, "platform")
      .setAlpha(0)
      .setScale(0.5, 0.02)
      .refreshBody();

    this.platforms
      .create(this.platformX + 865, this.platformY + 30, "platform")
      .setAlpha(0)
      .setScale(0.5, 0.02)
      .refreshBody();

    this.platforms
      .create(this.platformX + 865, this.platformY + 105, "platform")
      .setAlpha(0)
      .setScale(0.5, 0.02)
      .refreshBody();
    ...
    this.spawnCoins = (n) => {
      for (let i = 0; i < n; i++) {
        const x = Phaser.Math.Between(20, 1612);
    ...
    this.physics.world.setBounds(0, 0, 1628, 512);
    this.cameras.main.setBounds(0, 0, 1628, 512);
